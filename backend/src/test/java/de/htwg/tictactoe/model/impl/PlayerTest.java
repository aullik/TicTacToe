...
public class PlayerTest {
   ...
   public void testSetSymbol() {
      ...
      Assert.assertTrue(grids[0].cellIsSet(1, 1));
      Assert.assertFalse(move);
      Assert.assertFalse(player.setSymbol(1, 3, 0));
   }
   ...
   public void testResetPlayer() {
      ...
      Assert.assertTrue(player.setSymbol(1, 1, 2));
      player.resetPlayer();
      Assert.assertFalse(player.setSymbol(1, 1, 2));
   }
